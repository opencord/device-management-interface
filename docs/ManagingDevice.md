...
```
This RPC is used to administratively reboot the device. The server side implementations shahould reboot the device only after successfully returning this RPC.
