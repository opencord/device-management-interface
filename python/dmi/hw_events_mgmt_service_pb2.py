...
_EVENTIDS = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='EVENT_LINE_CARD_PLUG_OUT', index=45, number=600,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='EVENT_LINE_CARD_PLUG_IN', index=46, number=601,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_VALUETYPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='typeOfVal', full_name='dmi.ValueType.typeOfVal', index=3,
...
_EVENTCFG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='component_uuid', full_name='dmi.EventCfg.component_uuid', index=3,
...
_VALUETYPE.fields_by_name['typeOfVal'].enum_type = dmi_dot_hw__pb2._DATAVALUETYPE
...
_EVENTCFG.fields_by_name['component_uuid'].message_type = dmi_dot_hw__pb2._UUID
