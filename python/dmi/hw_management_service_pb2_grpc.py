...
class NativeHWManagementServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetLoggablePackage = channel.unary_unary(
                '/dmi.NativeHWManagementService/GetLoggablePackage',
                request_serializer=dmi_dot_hw__management__service__pb2.GetLoggablePackagesRequest.SerializeToString,
                response_deserializer=dmi_dot_hw__management__service__pb2.GetLoggablePackagesResponse.FromString,
                )
...
class NativeHWManagementServiceServicer(object):
    ...
    def GetLoggablePackage(self, request, context):
...
def add_NativeHWManagementServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetLoggablePackage': grpc.unary_unary_rpc_method_handler(
                    servicer.GetLoggablePackage,
                    request_deserializer=dmi_dot_hw__management__service__pb2.GetLoggablePackagesRequest.FromString,
                    response_serializer=dmi_dot_hw__management__service__pb2.GetLoggablePackagesResponse.SerializeToString,
            ),
...
class NativeHWManagementService(object):
    ...
    @staticmethod
    def GetLoggablePackage(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dmi.NativeHWManagementService/GetLoggablePackage',
            dmi_dot_hw__management__service__pb2.GetLoggablePackagesRequest.SerializeToString,
            dmi_dot_hw__management__service__pb2.GetLoggablePackagesResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
