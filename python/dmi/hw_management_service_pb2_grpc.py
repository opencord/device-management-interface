...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in dmi/hw_management_service_pb2_grpc.py depends on'
...
class NativeHWManagementServiceStub:
...
class NativeHWManagementServiceServicer:
    """Missing associated documentation comment in .proto file."""
...
def add_NativeHWManagementServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('dmi.NativeHWManagementService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class NativeHWManagementService:
    """Missing associated documentation comment in .proto file."""
