...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in dmi/hw_metrics_mgmt_service_pb2_grpc.py depends on'
...
class NativeMetricsManagementServiceStub:
...
class NativeMetricsManagementServiceServicer:
    """Missing associated documentation comment in .proto file."""
...
def add_NativeMetricsManagementServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('dmi.NativeMetricsManagementService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class NativeMetricsManagementService:
    """Missing associated documentation comment in .proto file."""
