...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in dmi/hw_events_mgmt_service_pb2_grpc.py depends on'
...
class NativeEventsManagementServiceStub:
...
class NativeEventsManagementServiceServicer:
    """Missing associated documentation comment in .proto file."""
...
class NativeEventsManagementService:
    """Missing associated documentation comment in .proto file."""
