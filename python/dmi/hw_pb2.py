...
_PORTCOMPONENTATTRIBUTES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pon_id', full_name='dmi.PortComponentAttributes.pon_id', index=5,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pon_id_trasmit_periodicity', full_name='dmi.PortComponentAttributes.pon_id_trasmit_periodicity', index=6,
...
_PORTCOMPONENTCHANGEATTRIBUTES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='pon_id', full_name='dmi.PortComponentChangeAttributes.pon_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pon_id_trasmit_periodicity', full_name='dmi.PortComponentChangeAttributes.pon_id_trasmit_periodicity', index=1,
