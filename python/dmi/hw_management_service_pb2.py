...
_PACKAGESLOGLEVEL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='logLevel', full_name='dmi.PackagesLogLevel.logLevel', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='packages', full_name='dmi.PackagesLogLevel.packages', index=1,
...
_SETDEVICELOGLEVEL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='loglevels', full_name='dmi.SetDeviceLogLevel.loglevels', index=1,
...
_GETLOGLEVELREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='packages', full_name='dmi.GetLogLevelRequest.packages', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SETDEVICELOGLEVEL.fields_by_name['loglevels'].message_type = _PACKAGESLOGLEVEL
...
_GETLOGLEVELRESPONSE.fields_by_name['logLevels'].message_type = _PACKAGESLOGLEVEL
