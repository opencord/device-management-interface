...
_SETLOGLEVELREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='logLevel', full_name='dmi.SetLogLevelRequest.logLevel', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='package', full_name='dmi.SetLogLevelRequest.package', index=2,
...
_SETLOGLEVELRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='response', full_name='dmi.SetLogLevelResponse.response', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SETLOGLEVELREQUEST.fields_by_name['logLevel'].enum_type = dmi_dot_commons__pb2._LOGLEVEL
_SETLOGLEVELRESPONSE.fields_by_name['response'].message_type = _DEVICELOGRESPONSE
