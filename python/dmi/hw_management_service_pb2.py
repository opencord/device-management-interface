...
_MANAGEDDEVICESRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='component', full_name='dmi.ManagedDevicesResponse.component', index=0,
...
_MANAGEDDEVICESRESPONSE.fields_by_name['component'].message_type = dmi_dot_hw__pb2._MODIFIABLECOMPONENT
