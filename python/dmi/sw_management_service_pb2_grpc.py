...
class NativeSoftwareManagementServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadDebugInfo = channel.unary_stream(
                ...
                response_deserializer=dmi_dot_sw__management__service__pb2.UploadDebugInfoResponse.FromString,
                )
...
def add_NativeSoftwareManagementServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UploadDebugInfo': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=dmi_dot_sw__management__service__pb2.UploadDebugInfoResponse.SerializeToString,
            ),
    }
...
class NativeSoftwareManagementService(object):
    ...
    def UploadDebugInfo(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/dmi.NativeSoftwareManagementService/UploadDebugInfo',
            ...
            dmi_dot_sw__management__service__pb2.UploadDebugInfoResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
