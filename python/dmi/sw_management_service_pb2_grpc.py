...
class NativeSoftwareManagementServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateStartupConfiguration = channel.unary_unary(
...
def add_NativeSoftwareManagementServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateStartupConfiguration': grpc.unary_unary_rpc_method_handler(
...
class NativeSoftwareManagementService(object):
    ...
    def UpdateStartupConfiguration(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dmi.NativeSoftwareManagementService/UpdateStartupConfiguration',
