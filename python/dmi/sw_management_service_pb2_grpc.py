...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in dmi/sw_management_service_pb2_grpc.py depends on'
...
class NativeSoftwareManagementServiceStub:
...
class NativeSoftwareManagementServiceServicer:
    """Missing associated documentation comment in .proto file."""
...
def add_NativeSoftwareManagementServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('dmi.NativeSoftwareManagementService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class NativeSoftwareManagementService:
    """Missing associated documentation comment in .proto file."""
