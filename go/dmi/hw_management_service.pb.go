...
func (m *PackagesLogLevel) GetPackages() []string {
	if m != nil {
		return m.Packages
	}
	return nil
...
type SetDeviceLogLevel struct {
	DeviceUuid           *Uuid               `protobuf:"bytes,1,opt,name=device_uuid,json=deviceUuid,proto3" json:"device_uuid,omitempty"`
	Loglevels            []*PackagesLogLevel `protobuf:"bytes,2,rep,name=loglevels,proto3" json:"loglevels,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *SetDeviceLogLevel) GetLoglevels() []*PackagesLogLevel {
	if m != nil {
		return m.Loglevels
	}
	return nil
...
func (m *GetLogLevelRequest) GetPackages() []string {
	if m != nil {
		return m.Packages
	}
	return nil
...
type GetLogLevelResponse struct {
	DeviceUuid           *Uuid               `protobuf:"bytes,1,opt,name=device_uuid,json=deviceUuid,proto3" json:"device_uuid,omitempty"`
	LogLevels            []*PackagesLogLevel `protobuf:"bytes,3,rep,name=logLevels,proto3" json:"logLevels,omitempty"`
...
func (m *GetLogLevelResponse) GetLogLevels() []*PackagesLogLevel {
	if m != nil {
		return m.LogLevels
	}
	return nil
...
var fileDescriptor_eae902e73066286d = []byte{
	...
	,
}
...
type NativeHWManagementServiceClient interface {
	...
	GetLoggablePackage(ctx context.Context, in *GetLoggablePackagesRequest, opts ...grpc.CallOption) (*GetLogLevelResponse, error)
	// Sets the log level for one or more devices for each given package certain level.
	// If only one PackageLogLevel is provided for a device and that request contains only a log level with
	// no package in the list it's assumed that the caller wants to set that level for all the packages.
	SetLogLevel(ctx context.Context, in *SetLogLevelRequest, opts ...grpc.CallOption) (*SetLogLevelResponse, error)
	// Gets the configured log level for a certain package on a certain device.
	// If no package is specified in the request all the packages with their log level should be returned.
...
func (c *nativeHWManagementServiceClient) GetLoggablePackage(ctx context.Context, in *GetLoggablePackagesRequest, opts ...grpc.CallOption) (*GetLogLevelResponse, error) {
...
type NativeHWManagementServiceServer interface {
	...
	// Gets the packages of a device on which log can be configured. A few are expected, like OS, PON Management etc.
	GetLoggablePackage(context.Context, *GetLoggablePackagesRequest) (*GetLogLevelResponse, error)
	// Sets the log level for one or more devices for each given package certain level.
	// If only one PackageLogLevel is provided for a device and that request contains only a log level with
	// no package in the list it's assumed that the caller wants to set that level for all the packages.
