...
func (*PhysicalInventoryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_39918916acbdafe0, []int{0}
}
...
func (*PhysicalInventoryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_39918916acbdafe0, []int{1}
}
...
func (*HWComponentInfoGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_39918916acbdafe0, []int{2}
}
...
func (*HWComponentInfoSetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_39918916acbdafe0, []int{3}
}
...
func (*HWComponentInfoSetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_39918916acbdafe0, []int{4}
}
...
func (*StartManagingDeviceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_39918916acbdafe0, []int{5}
}
...
func init() {
	proto.RegisterFile("dmi/hw_management_service.proto", fileDescriptor_39918916acbdafe0)
}

var fileDescriptor_39918916acbdafe0 = []byte{
	// 492 bytes of a gzipped FileDescriptorProto
	,
}
