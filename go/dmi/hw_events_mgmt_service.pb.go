...
const (
	...
	// the ports components of that transceiver and not on the transceiver
	// component itself. This is because there could be different thresholds
	// on the different ports of a transceiver (example for a transceiver of
...
type ValueType struct {
	// The scale of val should be in units. For e.g for memory val should be in bytes
	// and not in Kilo bytes or any other scale.
	//
...
func (m *EventsConfigurationRequest) GetComponentUuid() *Uuid {
	if m != nil {
