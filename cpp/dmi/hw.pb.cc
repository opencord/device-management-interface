...
const ::google::protobuf::uint32 TableStruct_dmi_2fhw_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::dmi::PonDistance, max_differential_reach_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_dmi_2fhw_2eproto[] =
  ...
  "istance\030\001 \001(\r\022\036\n\026max_differential_reach\030"
  "\002 \001(\r\"l\n\035PortComponentChangeAttributes\022\'"
  "\n\rpon_id_config\030\001 \001(\0132\020.dmi.PonIdConfig\022"
  "\"\n\010distance\030\002 \001(\0132\020.dmi.PonDistance\"P\n$T"
  "ransceiverComponentChangeAttributes\022(\n\nt"
  "rans_type\030\001 \001(\0162\024.dmi.TransceiverType\"B\n"
  "\013PonIdConfig\022\016\n\006pon_id\030\001 \001(\014\022#\n\033pon_id_t"
  "ransmit_periodicity\030\002 \001(\r\"6\n\034ContainerCo"
  "mponentAttributes\022\026\n\016physical_label\030\001 \001("
  "\t\"\263\001\n\026PsuComponentAttributes\022G\n\021supporte"
  "d_voltage\030\001 \001(\0162,.dmi.PsuComponentAttrib"
  "utes.SupportedVoltage\"P\n\020SupportedVoltag"
  "e\022\037\n\033SUPPORTED_VOLTAGE_UNDEFINED\020\000\022\007\n\003V4"
  "8\020\001\022\010\n\004V230\020\002\022\010\n\004V115\020\003\"\253\004\n\037TransceiverC"
  "omponentsAttributes\022D\n\013form_factor\030\001 \001(\016"
  "2/.dmi.TransceiverComponentsAttributes.F"
  "ormFactor\022(\n\ntrans_type\030\002 \001(\0162\024.dmi.Tran"
  "sceiverType\022\024\n\014max_distance\030\003 \001(\r\022+\n\022max"
  "_distance_scale\030\004 \001(\0162\017.dmi.ValueScale\022\025"
  "\n\rrx_wavelength\030\005 \003(\r\022\025\n\rtx_wavelength\030\006"
  " \003(\r\022)\n\020wavelength_scale\030\007 \001(\0162\017.dmi.Val"
  "ueScale\022\020\n\010tx_power\030\010 \003(\005\022\'\n\016tx_power_sc"
  "ale\030\t \001(\0162\017.dmi.ValueScale\"\300\001\n\nFormFacto"
...
::google::protobuf::internal::DescriptorTable descriptor_table_dmi_2fhw_2eproto = {
  ...
  "dmi/hw.proto", &assign_descriptors_table_dmi_2fhw_2eproto, 6507,
};
...
const int PonDistance::kMaxDifferentialReachFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
PonDistance::PonDistance(const PonDistance& from)
  ...
  ::memcpy(&max_distance_, &from.max_distance_,
    static_cast<size_t>(reinterpret_cast<char*>(&max_differential_reach_) -
    reinterpret_cast<char*>(&max_distance_)) + sizeof(max_differential_reach_));
...
void PonDistance::SharedCtor() {
  ::memset(&max_distance_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&max_differential_reach_) -
      reinterpret_cast<char*>(&max_distance_)) + sizeof(max_differential_reach_));
}
...
const char* PonDistance::_InternalParse(const char* begin, const char* end, void* object,
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      // uint32 max_differential_reach = 2;
      case 2: {
        if (static_cast<::google::protobuf::uint8>(tag) != 16) goto handle_unusual;
        msg->set_max_differential_reach(::google::protobuf::internal::ReadVarint(&ptr));
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        break;
      }
      default: {
...
void PonDistance::SerializeWithCachedSizes(
  ...
  // uint32 max_differential_reach = 2;
  if (this->max_differential_reach() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(2, this->max_differential_reach(), output);
  }
...
::google::protobuf::uint8* PonDistance::InternalSerializeWithCachedSizesToArray(
  ...
  // uint32 max_differential_reach = 2;
  if (this->max_differential_reach() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(2, this->max_differential_reach(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:dmi.PonDistance)
  ...
  if (from.max_differential_reach() != 0) {
    set_max_differential_reach(from.max_differential_reach());
  }
}
...
void PonDistance::InternalSwap(PonDistance* other) {
  ...
  swap(max_differential_reach_, other->max_differential_reach_);
}
