...
class PonDistance final :
 ...
 public:
  ...
  void clear_max_differential_reach();
  static const int kMaxDifferentialReachFieldNumber = 2;
  ::google::protobuf::uint32 max_differential_reach() const;
  void set_max_differential_reach(::google::protobuf::uint32 value);
 ...
 private:
  ...
  ::google::protobuf::uint32 max_differential_reach_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_dmi_2fhw_2eproto;
};
// -------------------------------------------------------------------
...
// uint32 max_differential_reach = 2;
inline void PonDistance::clear_max_differential_reach() {
  max_differential_reach_ = 0u;
}
inline ::google::protobuf::uint32 PonDistance::max_differential_reach() const {
  // @@protoc_insertion_point(field_get:dmi.PonDistance.max_differential_reach)
  return max_differential_reach_;
}
inline void PonDistance::set_max_differential_reach(::google::protobuf::uint32 value) {
  
  max_differential_reach_ = value;
  // @@protoc_insertion_point(field_set:dmi.PonDistance.max_differential_reach)
}
