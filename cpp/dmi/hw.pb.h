...
enum TransceiverComponentChangeAttributes_PonTech {
  TransceiverComponentChangeAttributes_PonTech_DEFAULT = 0,
  TransceiverComponentChangeAttributes_PonTech_GPON = 1,
  TransceiverComponentChangeAttributes_PonTech_XGPON = 2,
  TransceiverComponentChangeAttributes_PonTech_XGSPON = 3,
  TransceiverComponentChangeAttributes_PonTech_EPON = 4,
  TransceiverComponentChangeAttributes_PonTech_NGPON2 = 5,
  TransceiverComponentChangeAttributes_PonTech_CPON = 6,
  TransceiverComponentChangeAttributes_PonTech_TransceiverComponentChangeAttributes_PonTech_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  TransceiverComponentChangeAttributes_PonTech_TransceiverComponentChangeAttributes_PonTech_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
bool TransceiverComponentChangeAttributes_PonTech_IsValid(int value);
const TransceiverComponentChangeAttributes_PonTech TransceiverComponentChangeAttributes_PonTech_PonTech_MIN = TransceiverComponentChangeAttributes_PonTech_DEFAULT;
const TransceiverComponentChangeAttributes_PonTech TransceiverComponentChangeAttributes_PonTech_PonTech_MAX = TransceiverComponentChangeAttributes_PonTech_CPON;
const int TransceiverComponentChangeAttributes_PonTech_PonTech_ARRAYSIZE = TransceiverComponentChangeAttributes_PonTech_PonTech_MAX + 1;

const ::google::protobuf::EnumDescriptor* TransceiverComponentChangeAttributes_PonTech_descriptor();
inline const ::std::string& TransceiverComponentChangeAttributes_PonTech_Name(TransceiverComponentChangeAttributes_PonTech value) {
  return ::google::protobuf::internal::NameOfEnum(
    TransceiverComponentChangeAttributes_PonTech_descriptor(), value);
}
inline bool TransceiverComponentChangeAttributes_PonTech_Parse(
    const ::std::string& name, TransceiverComponentChangeAttributes_PonTech* value) {
  return ::google::protobuf::internal::ParseNamedEnum<TransceiverComponentChangeAttributes_PonTech>(
    TransceiverComponentChangeAttributes_PonTech_descriptor(), name, value);
}
...
enum TransceiverComponentsAttributes_Type {
  ...
  TransceiverComponentsAttributes_Type_NOT_DETECTED = 255,
...
const TransceiverComponentsAttributes_Type TransceiverComponentsAttributes_Type_Type_MAX = TransceiverComponentsAttributes_Type_NOT_DETECTED;
...
class TransceiverComponentChangeAttributes final :
 ...
 public:
  ...
  typedef TransceiverComponentChangeAttributes_PonTech PonTech;
  static const PonTech DEFAULT =
    TransceiverComponentChangeAttributes_PonTech_DEFAULT;
  static const PonTech GPON =
    TransceiverComponentChangeAttributes_PonTech_GPON;
  static const PonTech XGPON =
    TransceiverComponentChangeAttributes_PonTech_XGPON;
  static const PonTech XGSPON =
    TransceiverComponentChangeAttributes_PonTech_XGSPON;
  static const PonTech EPON =
    TransceiverComponentChangeAttributes_PonTech_EPON;
  static const PonTech NGPON2 =
    TransceiverComponentChangeAttributes_PonTech_NGPON2;
  static const PonTech CPON =
    TransceiverComponentChangeAttributes_PonTech_CPON;
  static inline bool PonTech_IsValid(int value) {
    return TransceiverComponentChangeAttributes_PonTech_IsValid(value);
  }
  static const PonTech PonTech_MIN =
    TransceiverComponentChangeAttributes_PonTech_PonTech_MIN;
  static const PonTech PonTech_MAX =
    TransceiverComponentChangeAttributes_PonTech_PonTech_MAX;
  static const int PonTech_ARRAYSIZE =
    TransceiverComponentChangeAttributes_PonTech_PonTech_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  PonTech_descriptor() {
    return TransceiverComponentChangeAttributes_PonTech_descriptor();
  }
  static inline const ::std::string& PonTech_Name(PonTech value) {
    return TransceiverComponentChangeAttributes_PonTech_Name(value);
  }
  static inline bool PonTech_Parse(const ::std::string& name,
      PonTech* value) {
    return TransceiverComponentChangeAttributes_PonTech_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // .dmi.TransceiverComponentChangeAttributes.PonTech tech = 1;
  void clear_tech();
  static const int kTechFieldNumber = 1;
  ::dmi::TransceiverComponentChangeAttributes_PonTech tech() const;
  void set_tech(::dmi::TransceiverComponentChangeAttributes_PonTech value);
...
class TransceiverComponentsAttributes final :
 ...
 public:
  ...
  static const Type NOT_DETECTED =
    TransceiverComponentsAttributes_Type_NOT_DETECTED;
...
// .dmi.TransceiverComponentChangeAttributes.PonTech tech = 1;
inline void TransceiverComponentChangeAttributes::clear_tech() {
  tech_ = 0;
}
inline ::dmi::TransceiverComponentChangeAttributes_PonTech TransceiverComponentChangeAttributes::tech() const {
  // @@protoc_insertion_point(field_get:dmi.TransceiverComponentChangeAttributes.tech)
  return static_cast< ::dmi::TransceiverComponentChangeAttributes_PonTech >(tech_);
}
inline void TransceiverComponentChangeAttributes::set_tech(::dmi::TransceiverComponentChangeAttributes_PonTech value) {
  
  tech_ = value;
  // @@protoc_insertion_point(field_set:dmi.TransceiverComponentChangeAttributes.tech)
}
...
template <> struct is_proto_enum< ::dmi::TransceiverComponentChangeAttributes_PonTech> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::dmi::TransceiverComponentChangeAttributes_PonTech>() {
  return ::dmi::TransceiverComponentChangeAttributes_PonTech_descriptor();
}
