 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientReaderInterface< ::dmi::UploadDebugInfoResponse>> UploadDebugInfo(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request) {
      return std::unique_ptr< ::grpc::ClientReaderInterface< ::dmi::UploadDebugInfoResponse>>(UploadDebugInfoRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::dmi::UploadDebugInfoResponse>> AsyncUploadDebugInfo(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::dmi::UploadDebugInfoResponse>>(AsyncUploadDebugInfoRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::dmi::UploadDebugInfoResponse>> PrepareAsyncUploadDebugInfo(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::dmi::UploadDebugInfoResponse>>(PrepareAsyncUploadDebugInfoRaw(context, request, cq));
    }
    class experimental_async_interface {
     public:
      ...
      // This API can be used to upload to a remote location, information useful for troubleshooting problems on the hardware
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void UploadDebugInfo(::grpc::ClientContext* context, ::dmi::UploadDebugInfoRequest* request, ::grpc::ClientReadReactor< ::dmi::UploadDebugInfoResponse>* reactor) = 0;
      #else
      virtual void UploadDebugInfo(::grpc::ClientContext* context, ::dmi::UploadDebugInfoRequest* request, ::grpc::experimental::ClientReadReactor< ::dmi::UploadDebugInfoResponse>* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  ...
  private:
    ...
    virtual ::grpc::ClientReaderInterface< ::dmi::UploadDebugInfoResponse>* UploadDebugInfoRaw(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::dmi::UploadDebugInfoResponse>* AsyncUploadDebugInfoRaw(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request, ::grpc::CompletionQueue* cq, void* tag) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::dmi::UploadDebugInfoResponse>* PrepareAsyncUploadDebugInfoRaw(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientReader< ::dmi::UploadDebugInfoResponse>> UploadDebugInfo(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request) {
      return std::unique_ptr< ::grpc::ClientReader< ::dmi::UploadDebugInfoResponse>>(UploadDebugInfoRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::dmi::UploadDebugInfoResponse>> AsyncUploadDebugInfo(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::dmi::UploadDebugInfoResponse>>(AsyncUploadDebugInfoRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::dmi::UploadDebugInfoResponse>> PrepareAsyncUploadDebugInfo(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::dmi::UploadDebugInfoResponse>>(PrepareAsyncUploadDebugInfoRaw(context, request, cq));
    }
    class experimental_async final :
     ...
     public:
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void UploadDebugInfo(::grpc::ClientContext* context, ::dmi::UploadDebugInfoRequest* request, ::grpc::ClientReadReactor< ::dmi::UploadDebugInfoResponse>* reactor) override;
      #else
      void UploadDebugInfo(::grpc::ClientContext* context, ::dmi::UploadDebugInfoRequest* request, ::grpc::experimental::ClientReadReactor< ::dmi::UploadDebugInfoResponse>* reactor) override;
      #endif
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientReader< ::dmi::UploadDebugInfoResponse>* UploadDebugInfoRaw(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request) override;
    ::grpc::ClientAsyncReader< ::dmi::UploadDebugInfoResponse>* AsyncUploadDebugInfoRaw(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request, ::grpc::CompletionQueue* cq, void* tag) override;
    ::grpc::ClientAsyncReader< ::dmi::UploadDebugInfoResponse>* PrepareAsyncUploadDebugInfoRaw(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // This API can be used to upload to a remote location, information useful for troubleshooting problems on the hardware
    virtual ::grpc::Status UploadDebugInfo(::grpc::ServerContext* context, const ::dmi::UploadDebugInfoRequest* request, ::grpc::ServerWriter< ::dmi::UploadDebugInfoResponse>* writer);
  };
  ...
  class WithAsyncMethod_UploadDebugInfo : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status UploadDebugInfo(::grpc::ServerContext* /*context*/, const ::dmi::UploadDebugInfoRequest* /*request*/, ::grpc::ServerWriter< ::dmi::UploadDebugInfoResponse>* /*writer*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestUploadDebugInfo(::grpc::ServerContext* context, ::dmi::UploadDebugInfoRequest* request, ::grpc::ServerAsyncWriter< ::dmi::UploadDebugInfoResponse>* writer, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class ExperimentalWithCallbackMethod_UploadDebugInfo : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_UploadDebugInfo() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(6,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::dmi::UploadDebugInfoRequest, ::dmi::UploadDebugInfoResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
    ...
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    virtual ::grpc::ServerWriteReactor< ::dmi::UploadDebugInfoResponse>* UploadDebugInfo(
      ::grpc::CallbackServerContext* /*context*/, const ::dmi::UploadDebugInfoRequest* /*request*/)
    #else
    virtual ::grpc::experimental::ServerWriteReactor< ::dmi::UploadDebugInfoResponse>* UploadDebugInfo(
   ...
   public:
    WithSplitStreamingMethod_UploadDebugInfo() {
      ::grpc::Service::MarkMethodStreamed(6,
        new ::grpc::internal::SplitServerStreamingHandler<
          ::dmi::UploadDebugInfoRequest, ::dmi::UploadDebugInfoResponse>(
            [this](::grpc_impl::ServerContext* context,
                   ::grpc_impl::ServerSplitStreamer<
                     ::dmi::UploadDebugInfoRequest, ::dmi::UploadDebugInfoResponse>* streamer) {
    ...
    // replace default version of method with split streamed
    virtual ::grpc::Status StreamedUploadDebugInfo(::grpc::ServerContext* context, ::grpc::ServerSplitStreamer< ::dmi::UploadDebugInfoRequest,::dmi::UploadDebugInfoResponse>* server_split_streamer) = 0;
  };
