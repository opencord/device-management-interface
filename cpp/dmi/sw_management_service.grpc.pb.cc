...
::grpc::ClientReader< ::dmi::UploadDebugInfoResponse>* NativeSoftwareManagementService::Stub::UploadDebugInfoRaw(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request) {
  return ::grpc_impl::internal::ClientReaderFactory< ::dmi::UploadDebugInfoResponse>::Create(channel_.get(), rpcmethod_UploadDebugInfo_, context, request);
}

void NativeSoftwareManagementService::Stub::experimental_async::UploadDebugInfo(::grpc::ClientContext* context, ::dmi::UploadDebugInfoRequest* request, ::grpc::experimental::ClientReadReactor< ::dmi::UploadDebugInfoResponse>* reactor) {
  ::grpc_impl::internal::ClientCallbackReaderFactory< ::dmi::UploadDebugInfoResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_UploadDebugInfo_, context, request, reactor);
}

::grpc::ClientAsyncReader< ::dmi::UploadDebugInfoResponse>* NativeSoftwareManagementService::Stub::AsyncUploadDebugInfoRaw(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc_impl::internal::ClientAsyncReaderFactory< ::dmi::UploadDebugInfoResponse>::Create(channel_.get(), cq, rpcmethod_UploadDebugInfo_, context, request, true, tag);
}

::grpc::ClientAsyncReader< ::dmi::UploadDebugInfoResponse>* NativeSoftwareManagementService::Stub::PrepareAsyncUploadDebugInfoRaw(::grpc::ClientContext* context, const ::dmi::UploadDebugInfoRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncReaderFactory< ::dmi::UploadDebugInfoResponse>::Create(channel_.get(), cq, rpcmethod_UploadDebugInfo_, context, request, false, nullptr);
}
...
NativeSoftwareManagementService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::SERVER_STREAMING,
      new ::grpc::internal::ServerStreamingHandler< NativeSoftwareManagementService::Service, ::dmi::UploadDebugInfoRequest, ::dmi::UploadDebugInfoResponse>(
          [](NativeSoftwareManagementService::Service* service,
             ::grpc_impl::ServerContext* ctx,
             const ::dmi::UploadDebugInfoRequest* req,
             ::grpc_impl::ServerWriter<::dmi::UploadDebugInfoResponse>* writer) {
...
::grpc::Status NativeSoftwareManagementService::Service::UploadDebugInfo(::grpc::ServerContext* context, const ::dmi::UploadDebugInfoRequest* request, ::grpc::ServerWriter< ::dmi::UploadDebugInfoResponse>* writer) {
  (void) context;
  (void) request;
  (void) writer;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
