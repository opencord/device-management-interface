...
// .dmi.Uuid device_uuid = 1;
inline bool RebootDeviceResponse::has_device_uuid() const {
  return this != internal_default_instance() && device_uuid_ != nullptr;
}
inline const ::dmi::Uuid& RebootDeviceResponse::device_uuid() const {
  const ::dmi::Uuid* p = device_uuid_;
  // @@protoc_insertion_point(field_get:dmi.RebootDeviceResponse.device_uuid)
  return p != nullptr ? *p : *reinterpret_cast<const ::dmi::Uuid*>(
      &::dmi::_Uuid_default_instance_);
}
inline ::dmi::Uuid* RebootDeviceResponse::release_device_uuid() {
  // @@protoc_insertion_point(field_release:dmi.RebootDeviceResponse.device_uuid)
  
  ::dmi::Uuid* temp = device_uuid_;
  device_uuid_ = nullptr;
  return temp;
}
inline ::dmi::Uuid* RebootDeviceResponse::mutable_device_uuid() {
  
  if (device_uuid_ == nullptr) {
    auto* p = CreateMaybeMessage<::dmi::Uuid>(GetArenaNoVirtual());
    device_uuid_ = p;
  }
  // @@protoc_insertion_point(field_mutable:dmi.RebootDeviceResponse.device_uuid)
  return device_uuid_;
}
inline void RebootDeviceResponse::set_allocated_device_uuid(::dmi::Uuid* device_uuid) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(device_uuid_);
  }
  ...
  device_uuid_ = device_uuid;
  // @@protoc_insertion_point(field_set_allocated:dmi.RebootDeviceResponse.device_uuid)
}
